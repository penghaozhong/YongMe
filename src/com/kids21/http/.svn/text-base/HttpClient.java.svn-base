...
import com.kids21.sjb.RefuseError;
import com.kids21.util.DebugTimer;
...
public class HttpClient {
	...
	private static final String SERVER_HOST = "api.kids21.com";
	...
	public static String baseURL = Configuration.getScheme() + "192.168.1.23:8888/phpcms/";
	...
	private HttpUriRequest createMethod(String httpMethod, URI uri, File file,
		...
		if (httpMethod.equalsIgnoreCase(HttpPost.METHOD_NAME)) {
			...
			try {
				...
				if (null != file) {
					entity = createMultipartEntity("f", file, postParams);
