...
import com.kids21.util.Tools;
import com.kids21.view.MyImageView.OnViewClick;
...
public class ItemView extends LinearLayout {
	...
	public void a(int paramInt) {
		...
		int i1 = Tools.a(getContext(), 10);
		int i2 = Tools.a(getContext(), 15);
		int i3 = Tools.a(getContext(), 13);
		switch (paramInt) {
		default:
		case 0:
