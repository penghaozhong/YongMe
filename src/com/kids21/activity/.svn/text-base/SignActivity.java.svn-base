					...
					new Thread() {
						...
						public void run() {
							try {
								...
								Kids21Application.http.httpRequest(HttpClient.baseURL +"index.php?m=location&c=loandge", Kids21Application.http.createParams(new BasicNameValuePair("name", currentlyName),
